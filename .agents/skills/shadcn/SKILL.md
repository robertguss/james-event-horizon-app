...
allowed-tools: Bash(npx shadcn@latest *), Bash(pnpm dlx shadcn@latest *), Bash(aubx shadcn@latest *), Bash(bunx --bun shadcn@latest *)
---
...
> **IMPORTANT:** Run all CLI commands using the project's package runner: `npx shadcn@latest`, `pnpm dlx shadcn@latest`, `aubx shadcn@latest`, or `bunx --bun shadcn@latest` — based on the project's lockfile. Examples below use `npx shadcn@latest` but substitute the correct runner for the project.
